...
{
    static const touchgfx::FontId DEFAULT = 0; // RetroGaming_20_4bpp
    static const touchgfx::FontId LARGE = 1;   // RetroGaming_40_4bpp
    static const touchgfx::FontId SMALL = 2;   // RetroGaming_10_4bpp
